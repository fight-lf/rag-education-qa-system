...
def main(query_mode=True, directory_path="data"):
    ...
    # 根据模式执行不同操作
        # 根据模式执行不同操作
    if not query_mode: #  query_mode = False ,加载文件，并进行向量化存储的
        # --- 数据处理模式 ---
...
if __name__ == '__main__':
    # main(query_mode=False, directory_path=r"D:\workspace\workspace_python\llm-05\dev02_rag\integrated_qa_system\rag_qa\data\test_data")
    main(query_mode=True, directory_path=r"D:\python10.4\integrated_qa_system\rag_qa\data\test_data")
